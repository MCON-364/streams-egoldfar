...
public class StreamExercise {
    ...
    public List<String> getAllStudentNames() {
        ...
        return gradebook.keySet().stream().sorted(String::compareToIgnoreCase).toList();
    }
    ...
    public List<Integer> getStudentGrades(String studentName) {
        ...
        Optional<List<Integer>> temp = Optional.ofNullable(gradebook.get(studentName));
        return temp.orElse(Collections.emptyList());
    }
    // =========================================================================
    ...
    public double calculateAverage(String studentName) {
        ...
        OptionalDouble average = getStudentGrades(studentName)
                .stream()
    ...
    public int findHighestGrade() {
        ...
        var max = gradebook.values().stream()
                .flatMap(List::stream)
                .mapToInt(Integer::intValue)
                .max();
    ...
    public int findLowestGrade() {
        var min = gradebook.values().stream()
                .flatMap(List::stream)
                .mapToInt(Integer::intValue)
                .min();
    ...
    public List<String> getPassingStudents(double threshold) {
        ...
        return gradebook.keySet().stream()
                .filter(s -> calculateAverage(s) >= threshold)
                .toList();
    }
    ...
    public String findTopPerformer() {
        ...
        var max = gradebook.keySet().stream()
                .max(Comparator.comparing(this::calculateAverage));
        return max.orElse("");
    }
